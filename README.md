...
* **🗺️ Level Design Avansat:** * Zonă urbană densă (peste 30 de clădiri/blocuri explorabile).
...
## 🗺️ Roadmap (Planuri de Viitor)

Proiectul este în continuă dezvoltare. Iată ce urmează să fie implementat:
- [ ] **Inteligență Artificială (AI):** Inamici cu comportament de patrulare și atac.
- [ ] **Sistem de Sănătate/Vindecare:** Implementarea pachetelor medicale.
- [ ] **Multiplayer:** Suport de bază pentru sesiuni de tip Peer-to-Peer.
- [ ] **Misiuni:** Sistem de obiective (Quest system) pentru a ghida jucătorul pe hartă.
